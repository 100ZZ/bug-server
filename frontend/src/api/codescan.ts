...
export const getCodeScans = (params?: { project_id?: number; keyword?: string; result?: string; page?: number; page_size?: number }) => {
  return request.get<any, { total: number; items: CodeScan[]; page: number; page_size: number }>('/code-scans', { params })
}
