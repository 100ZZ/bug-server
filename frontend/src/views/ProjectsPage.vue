    ...
    <el-card class="table-card">
      ...
      <div style="margin-top: 16px; text-align: right;">
        <el-pagination
          ...
          @size-change="() => { currentPage.value = 1; loadProjects() }"
        />
      </div>
    </el-card>
...
const loadProjects = async () => {
  loading.value = true
  try {
    const res = await projectApi.getProjects({ keyword: searchKeyword.value || undefined, page: currentPage.value, page_size: pageSize.value })
