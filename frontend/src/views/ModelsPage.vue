  ...
  <div class="models-page">
    ...
    <el-card class="filter-card">
      ...
      <div class="filter-row">
        ...
        <el-button @click="() => { currentPage.value = 1; fetchModels() }">搜索</el-button>
        <el-button @click="() => { searchKeyword = ''; currentPage.value = 1; fetchModels() }">重置</el-button>
        <el-button 
          type="primary" 
          @click="handleCreate"
          :disabled="!canCreate('models')"
        >
    ...
    <el-card class="table-card">
      ...
      <div style="margin-top: 12px; text-align: right;">
        <el-pagination
          ...
          @size-change="() => { currentPage.value = 1; fetchModels() }"
        />
      </div>
    </el-card>
...
const fetchModels = async () => {
  loading.value = true
  try {
    const res = await modelApi.getModels({ keyword: searchKeyword.value || undefined, page: currentPage.value, page_size: pageSize.value })
    models.value = res.items
    totalModels.value = res.total
  } catch (error: any) {
