...
class RequirementChildOut(BaseModel):
    """子需求（轻量，不含递归children）"""
    id: int
    parent_id: Optional[int] = None
    title: str
...
class RequirementOut(RequirementBase):
    ...
    children: List[RequirementChildOut] = []
...
class WorkTaskChildOut(BaseModel):
    """子任务（轻量，不含递归 children）"""
    id: int
    parent_id: Optional[int] = None
    title: str
    priority: str
...
class WorkTaskOut(WorkTaskBase):
    ...
    assignee: Optional['UserBrief'] = None
    creator: Optional['UserBrief'] = None
    children: List[WorkTaskChildOut] = []
...
# ===== TestCaseDirectory Schemas =====
class TestCaseDirectoryCreate(BaseModel):
    project_id: int
    path: str
    name: str

class TestCaseDirectoryUpdate(BaseModel):
    path: Optional[str] = None
    name: Optional[str] = None

class TestCaseDirectoryResponse(BaseModel):
    id: int
    project_id: int
    path: str
    name: str
